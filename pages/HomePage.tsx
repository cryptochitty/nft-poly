...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center h-[calc(100vh-120px)]">
      ...
      {!isConnected ? (
         <button onClick={connectWallet} className="px-8 py-4 bg-gradient-to-r from-orange-500 to-red-600 text-white font-bold rounded-lg shadow-lg hover:scale-105 transform transition-transform duration-300 ease-in-out font-orbitron">
           CONNECT WALLET TO PLAY
         </button>
      ) : (
        <form onSubmit={handleStartGame} className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <input
            type="text"
            value={playerName}
